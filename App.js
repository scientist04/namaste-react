...
const RestaurentCard = (props) => {
    ...
    return (
        <div className="res-card" style={{backgroundColor: "#f0f0f0"}}>
            <img 
              className="res-logo"
              src="https://media-assets.swiggy.com/swiggy/image/upload/fl_lossy,f_auto,q_auto,w_660/a621fa2337beff38368bb19988d27fcb" 
              alt="res-logo"
            />
            <h3>{props.resName}</h3>
            <h4>{props.cuisine}</h4>
    ...
    return (
        <div className="body">
            ...
            <div className="res-container">
                <RestaurentCard resName="BurgerClub" cuisine="Burger, North Indian, Asian"/>
                <RestaurentCard resName="KFC" cuisine="Burger, French Fries"/>
            </div>
        </div>
    );
};
